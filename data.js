...
const DEFAULT_SITE_DATA = {
    ...
    prices: [
        ...
        { name: "Профессиональная гигиена", priceFrom: 5500, note: null },
        { name: "Лечение кариеса", priceFrom: 4500, note: null },
        { name: "Отбеливание ZOOM 4", priceFrom: 15000, note: null },
        { name: "Винир E-max (1 единица)", priceFrom: 28000, note: "Популярно", accent: true },
        { name: "Имплант Straumann + коронка", priceFrom: 38000, note: null },
        { name: "Элайнеры (полный курс)", priceFrom: 180000, note: null },
        { name: "Коронка диоксид циркония", priceFrom: 22000, note: null }
    ],
